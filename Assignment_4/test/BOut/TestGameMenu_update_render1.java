...
public class TestGameMenu_update_render1 {
  ...
  public void testUpdate_QuitQuit () {
    ...
    menu.update(50);
    assertTrue(menu.state.getMenuString(menu).startsWith("Quit"));
    menu.update(50);
    assertTrue(menu.state.getMenuString(menu).startsWith("Quit"));
  ...
  public void testUpdate_QuitNo () {
    ...
    assertTrue(menu.state.getMenuString(menu).startsWith("Quit"));
    menu.update(50);
    assertTrue(menu.state.getMenuString(menu).contains("Level"));
    assertFalse(menu.sawFinish);
  ...
  public void testUpdate_LevelBackwardForward () {
    ...
    menu.update(50);
    assertEquals(menu.state.getChoiceString(menu), "Level1");
    menu.update(50);
    assertEquals(menu.state.getChoiceString(menu), "Level3");
    menu.update(50);
    assertEquals(menu.state.getChoiceString(menu), "Level1");
    assertFalse(menu.sawFinish);
