...
public class GameMenu extends GameObject {
	...
	protected static boolean buggy = false;
	// if (buggy) { original buggy code } else { correct code }
	...
	private enum Mode {
		...
		Archives {
			...
			State getOppositeState () { 
				if(buggy)
					return State.ChoosingArchive;
				else
					return State.ChoosingLevel; }
